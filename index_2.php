	...
	<div id="app">
		...
		<div class="view view-main view-init" data-url="/">
			<div class="page page-home page-with-subnavbar page-current">
                            <div class="toolbar tabbar tabbar-labels toolbar-bottom" style=" background: #ff1a1a !important; display: none;"> 
						...
						<div class="panel panel-left panel-cover sidebar">
							<div class="list accordion-list">
                                ...
                                <ul id="slide-out" class="sidenav">
                                    ...
                                    <li style="margin-top:-15px;"><a href="index.php" class="external link" style="margin-left: 40px !important; color:black">

                                            <div class="item-inner">
                                                <div class="item-title">Home
                                                    
                                                </div>
<a class="panel-close"> <i class="fa fa-times" style="color:black;"></i> </a>
                                            </div>
                                        </a></li>
							...
							<div class="container">
								...
								<div class="row">
									<div class="col-50">
										<div class="content content-shadow-product">
											<a href="/product-details/">
                                                                                            <Center><img src="images/buffet.jpg" alt="product" class="img2">
												<div class="text">
													<p class="title-product">Buffet Service</p>
									...
									<div class="col-50">
										<div class="content content-shadow-product">
											<a href="/product-details/">
                                                                                             <Center><img src="images/character.jpg" alt="product" class="img2">
												<div class="text">
								...
								<div class="row">
									<div class="col-50">
										<div class="content content-shadow-product">
											<a href="/product-details/">
                                                                                             <Center><img src="images/djparty.jpg" alt="product" class="img2">
												<div class="text">
													<p class="title-product">DJ Party</p>
									...
									<div class="col-50">
										<div class="content content-shadow-product">
											<a href="/product-details/">
                                                                                             <Center><img src="images/magicians.jpg" alt="product" class="img2">
												<div class="text">
													<p class="title-product">Magicians</p>
