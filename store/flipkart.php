...
.md .page.page-with-subnavbar .navbar-inner {
    overflow: visible;
    color: white;
    background: rgb(19, 250, 130) !important;
}
	...
	<div id="app">
		...
		<div class="view view-main view-init" data-url="/">
			<div class="page page-home page-with-subnavbar page-current">
                            <div class="toolbar tabbar tabbar-labels toolbar-bottom" style="background: rgb(19, 250, 130) !important; display: none;"> 
                                              <center>  <h3 style="margin-top: 11px; color: white"> 
                                                      <a href="Register.html" class="external link" 
                                                         
                                                         style="color:white; font-size:17px;    margin-top: -5px;">
                            ...
                            <div class="navbar navbar-home" style="margin-top: -9x;">
							<div class="navbar-inner">
								...
								<div class="title">
                                                                    <h2 style="font-family:Cookie;font-size:26px; color:white;"><center>Company Name <center></h2>
								</div>
				...
				<div class="tabs">
					<div id="tab-home" class="tab tab-active tab-home">
						...
						<div class="panel panel-left panel-cover sidebar">
							<div class="list accordion-list">
								              <ul id="slide-out" class="sidenav">
                                                          ...
                                                          <li style="background:rgb(19, 250, 130);"><a href="#!">
                                            <div class="item-inner">
                                                <div class="item-title" style="margin-bottom: -8px;"> &nbsp;&nbsp;&nbsp; &nbsp;  &nbsp; &nbsp;<font size="4" style="color:white;">
                                                    <i class="fa fa-user-circle-o" style="color:grey;"></i> &nbsp;Hello, Nikhil </font> </div></a>
                                        </div>
								...
								<div data-pagination="{&quot;el&quot;: &quot;.swiper-pagination&quot;}" data-space-between="10" class="swiper-container swiper-init swiper-container-horizontal swiper-container-initialized swiper-container-ios">
									...
									<div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
										<div class="swiper-slide swiper-slide-active" style="width: 351px; margin-right: 10px;">
											<div class="content">
												<div class="mask"></div>
                                                                                                <img src="images/tempBanner1.jpg" alt="">
											</div>
										</div>
						...
						<!-- cateogries -->
                                                <div class="categories segments" style="display:block;">
							...
							<div class="container">
                                                            <div class="row">
                                                                	<div class="col-20">
                                                                            <div class="content">
                                                                                <img src="images/buffet.jpg" style="width:100%; height: 65px;">
                                                                ...
                                                                <div class="col-20">
                                                                            <div class="content">
                                                                                <img src="images/character.jpg" style="width:100%;height: 65px;">
                                                                                <span>Character</span>
                                                                            </div>
                                                                ...
                                                                <div class="col-20">
                                                                            <div class="content">
                                                                                <img src="images/led.jpg" style="width:100%;height: 65px;">
                                                                                <span>LED Stage</span>
                                                                            </div>
                                                                 ...
                                                                 <div class="col-20">
                                                                            <div class="content">
                                                                                <img src="images/sweet.jpg" style="width:100%;height: 65px;">
                                                                                <span>Sweet Corner</span>
                                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                	<div class="col-20">
                                                                            <div class="content">
                                                                                <img src="images/djparty.jpg" style="width:100%;height: 65px;">
                                                                                <span>Dj Party</span>
                                                                            </div>
                                                                ...
                                                                <div class="col-20">
                                                                            <div class="content">
                                                                                <img src="images/videography.jpg" style="width:100%;height: 65px;">
                                                                ...
                                                                <div class="col-20">
                                                                            <div class="content">
                                                                                <img src="images/magicians.jpg" style="width:100%;height: 65px;">
                                                                                <span>Magicians</span>
                                                                            </div>
                                                                 ...
                                                                 <div class="col-20">
                                                                            <div class="content">
                                                                                <img src="images/facepaint.jpg" style="width:100%;height: 65px;">
						...
						<!-- flash sale -->
                                                <br><br>
                                                <div class="flash-sale segments no-pd-b" style="display:none;">
							<div class="container">
								<div class="section-title flash-s-title">
									<h3>BEST OFFERINGS FOR HER</h3>
														...
														<div class="product-mark-discount">
															<ul>
																...
																<li>OFF</li>
                                                                                                            ...
                                                                                                            <img src="images/item-7.jpg" alt="flash-sale" style="">
                                                                                                    </a>
														<div class="text">
															<p>₹500 <span>₹100</span></p>
														</div>
														...
														<div class="product-mark-discount">
															<ul>
																...
																<li>OFF</li>
                                                                                                            ...
                                                                                                            <img src="images/item-10.jpg" alt="flash-sale" style="">
														<div class="text">
															<p>₹400 <span>₹80</span></p>
														</div>
													</a>
												</div>
											</div>
														...
														<div class="product-mark-discount">
															<ul>
																...
																<li>OFF</li>
                                                                                                            ...
                                                                                                            <img src="images/item-13.jpg" alt="flash-sale" style="">
														<div class="text">
															<p>₹660 <span>₹1330</span></p>
														</div>
													</a>
												</div>
											</div>
						...
						<!-- popular product -->
                                                ...
                                                <style>
                                                    ...
                                                    <div class="popular-product segments-bottom" style="display:none;">
							<div class="container">
										...
										<div class="swiper-slide swiper-slide-active" style="width: 110.333px; margin-right: 10px;">
											<div class="content content-shadow-product">
												<a href="/product-details/">
													...
													<div class="text">
														<p class="title-product">Fisher Price Laugh & Learn Smart Stages Chair - Yellow</p>
										...
										<div class="swiper-slide swiper-slide-next" style="width: 110.333px; margin-right: 10px;">
											<div class="content content-shadow-product">
												<a href="/product-details/">
													...
													<div class="text">
														<p class="title-product">Fisher Price - Brilliant Basics Babys First Blocks Set</p>
										...
										<div class="swiper-slide" style="width: 110.333px; margin-right: 10px;">
											<div class="content content-shadow-product">
												<a href="/product-details/">
													...
													<div class="text">
														<p class="title-product">Babyhug Aquatic Musical Activity Table - Multicolor</p>
										...
										<div class="swiper-slide" style="width: 110.333px; margin-right: 10px;">
											<div class="content content-shadow-product">
												<a href="/product-details/">
													...
													<div class="text">
														<p class="title-product">Leap Frog My Own Leaptop - Green Blue</p>
						...
						<!-- recommended -->
                                                <div class="recommended product segments-bottom" style="margin-top:-40px !important;">
							<div class="container">
								<div class="section-title">
									<h3>Best Selling Toys
										<a href="#" class="see-all-link">See All</a>
									</h3>
								</div>
								<div class="row">
									<div class="col-50">
										<div class="content content-shadow-product">
											<a href="/product-details/">
                                                                                            <Center><img src="images/toys1.jpg" alt="product" class="img">
												<div class="text">
													<p class="title-product">Fisher Price Laugh & Learn Smart Stages Chair - Yellow</p>
									...
									<div class="col-50">
										<div class="content content-shadow-product">
											<a href="/product-details/">
                                                                                             <Center><img src="images/toys2.jpg" alt="product" class="img">
												<div class="text">
													<p class="title-product">
                                                                                                            Ratnas Educational Electro Board - General Science</p>
								...
								<div class="row">
									<div class="col-50">
										<div class="content content-shadow-product">
											<a href="/product-details/">
                                                                                             <Center><img src="images/toys3.jpg" alt="product" class="img">
												<div class="text">
													<p class="title-product">Smartcraft Funny Cottage Activity Toy - Multicolour</p>
									...
									<div class="col-50">
										<div class="content content-shadow-product">
											<a href="/product-details/">
                                                                                             <Center><img src="images/toys4.jpg" alt="product" class="img">
												<div class="text">
													<p class="title-product">Leap Frog My Own Leaptop - Green Blue/p>
